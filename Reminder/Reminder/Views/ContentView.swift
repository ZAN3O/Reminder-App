...
//  Email Login Page
//
//  Created by Simon Steuer on 09/06/21.
        ...
        NavigationView{
            ...
            VStack{
                ...
                if self.status{
                    ...
                    CardListView(cardListViewModel:CardListViewModel(), cardViewModel: CardViewModel(studyCard:))
...
struct Login : View {
    ...
    func verify(){
        ...
        if self.email != "" && self.pass != ""{
            ...
            self.error = "Veuillez remplir tous les critères demandés"
            self.alert.toggle()
        }
    }
    ...
    func reset(){
        ...
        if self.email != ""{
            ...
            self.error = "Veuillez renseigner une adresse email"
            self.alert.toggle()
        }
    }
}
